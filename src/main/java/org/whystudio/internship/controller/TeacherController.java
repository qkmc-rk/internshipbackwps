...
public class TeacherController extends BaseController {
    ...
    @Auth(role = Const.AUTH_TEACHER)
    public JsonResult modifyPersonalInfo(@RequestHeader(required = false) String token, Teacher teacher) {
    ...
    @Auth(role = Const.AUTH_TEACHER)
    public JsonResult listMyStudent(@RequestHeader(required = false) String token) {
    ...
    @Deprecated
    @Auth(role = Const.AUTH_TEACHER)
    public JsonResult listMyStudentByCondition(@RequestHeader(required = false) String token,
    ...
    @Auth(role = Const.AUTH_TEACHER)
    public JsonResult studentReport(@RequestHeader(required = false) String token,
    ...
    @Auth(role = Const.AUTH_TEACHER)
    @StageValidation(type = Const.STAGE_REPORT, stage = Const.STAGE_ON)
    public JsonResult evalStudentReport1(@RequestHeader(required = false) String token,
                                         @PathVariable String stuno,
    ...
    @Auth(role = Const.AUTH_TEACHER)
    @StageValidation(type = Const.STAGE_REPORT, stage = Const.STAGE_ON)
    public JsonResult evalStudentReport2(@RequestHeader(required = false) String token,
                                         @PathVariable String stuno,
    ...
    @Auth(role = Const.AUTH_TEACHER)
    @StageValidation(type = Const.STAGE_REPORT, stage = Const.STAGE_ON)
    public JsonResult evalStudentReportTotal(@RequestHeader(required = false) String token,
                                             @PathVariable String stuno,
    ...
    @Auth(role = Const.AUTH_TEACHER)
    public JsonResult studentAppraisal(@RequestHeader(required = false) String token,
                                       @PathVariable String stuno) {
    ...
    public JsonResult evalStudentAppraisal(@RequestHeader(required = false) String token,
                                           @PathVariable String stuno,
                                           @RequestParam(required = false) String corpTeacherGrade,
                                           @RequestParam(required = false) String leaderOpinion) {
        return teacherService.evalStudentAppraisal(token, stuno, corpTeacherGrade, leaderOpinion);
    }
